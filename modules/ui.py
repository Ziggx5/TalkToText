...
def start_ui():
    ...
    create_file_button = CTkButton(app, text = "", fg_color = "#3d3d3d", text_color = "white", corner_radius = 5, image = images["add.png"], compound = "right", width = 30, height = 30, font = ("TkTextFont", 15), hover_color= "gray")
